...
#define ADDRESS_TYPE_COUNT 7
enum TYPE_HEADER_FIELD {NO = -1, FROM = 0, TO = 1, CC = 2, BCC = 3, REPLY = 4, RESENT_TO = 5, RESENT_FROM = 6, SUBJECT = 7} ;
...
class ImapMessage {
    public:
        ...
        void setAddresses (const QStringList& addresses, int type);
